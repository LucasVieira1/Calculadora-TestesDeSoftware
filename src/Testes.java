...
public class Testes {
	public static void main(String[] args) {
		...
		int divisao = div.dividir(3, 7); // criando um atributo do tipo "int", chamando o metodo dividir com os valores
											// declarados
		System.out.println(divisao); // printando o atibuto "Divisão" no console, vai retornar um erro, pois o
										// atributo é do tipo "int", o resultado vai ser um "float", a solução seria
										// trocar
										// os atributos do metodo "dividir" e do atributo "divisão" para float, o tipo
										// "int"
										// não é recomendado para esse tipo de cálculo.

		divisao = div.dividir(3, 0);
		System.out.println(divisao); // printando o atibuto "Divisão" no console, vai retornar um erro, pois o numero
										// "3" não é divisível por "0", não é possivel dividir um número inteiro por "0"

		divisao = div.dividir(0, 0);
		System.out.println(divisao); // printando o atibuto "Divisão" no console, vai retornar um erro, pois "0"
										// dividido pra "0" é igual a um resultado indefinido

		divisao = div.dividir(3, -1);
		System.out.println(divisao); // printando o atibuto "Divisão" no console, vai retornar "-3"
